            ...
            <Center w={"100%"} minH={"170px"} mt="50px"   >
                <Box maxW={"80%"} minH={"150px"}    >
                    ...
                    <Text noOfLines={[25, 16, 6]} color="blackAlpha.900" fontSize="md">
                        ...
                        If you're an individual interested in joining a team, please visit our <Link style={{ color: "blue" }} to={"/join-the-movementr"}>SparkCities</Link> page to see if your city is listed. From there you can see visit one of our
